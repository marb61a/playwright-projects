      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _this$screen = this.screen, page = _this$screen.page, browser = _this$screen.browser; // Use here instead of after all which would create screenshots in every context
